...
public class PaymentApi {
	...
	private static String wunifiedOrderUrl = "https://pay.swiftpass.cn/pay/gateway";
	 ...
	 * @return
	 */
	public static String wpushOrder(Map<String, String> params){
		String xml = PaymentKit.wtoXml(params);
		return HttpUtils.post(wunifiedOrderUrl, xml);
	}
	...
	public static String wrefundUrl = "https://pay.swiftpass.cn/pay/gateway";
	...
	public static Map<String, String> refund(Map<String, String> params, String paternerKey) {
		String sign = PaymentKit.createSign(params, paternerKey);
		params.put("sign", sign);
		String xmlStr = HttpKit.post(wrefundUrl, PaymentKit.toXml(params));
		return PaymentKit.xmlToMap(xmlStr);
	}
	/**
