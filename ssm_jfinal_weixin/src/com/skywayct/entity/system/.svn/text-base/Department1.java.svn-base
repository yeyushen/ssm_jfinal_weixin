package com.skywayct.entity.system;
...
public class Department1 {
	...
	private List<Department1> subDepartment;//根据父节点获取所有子节点部门
	...
	public List<Department1> getSubDepartment() {
		return subDepartment;
	}
	public void setSubDepartment(List<Department1> subDepartment) {
