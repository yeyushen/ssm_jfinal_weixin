package com.skywayct.service.system.role.impl;
...
public class RoleService implements RoleManager{
	 ...
	 * @throws Exception
	 */
	public void updateRoleNewsRights(Role role) throws Exception {
		dao.update("RoleMapper.updateRoleNewsRights", role);
	}
	 ...
	 * @throws Exception
	 */
	public void setAllNewsRights(PageData pd) throws Exception {
		dao.update("RoleMapper.setAllNewsRights", pd);
	}
