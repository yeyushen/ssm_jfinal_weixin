package com.skywayct.service.system.user.impl;
...
public class UserService implements UserManager{
	 ...
	 * @throws Exception
	 */
	public PageData findByProxyId(PageData pd)throws Exception{
		return (PageData)dao.findForObject("UserMapper.findByProxyId", pd);
	}
	 ...
	 */
	@Override
	public void updateUserTryCount(PageData pd) throws Exception {
		// TODO Auto-generated method stub
		dao.update("UserMapper.updateErrorCount", pd);
	}
	 ...
	 */
	@Override
	public PageData findUserLock(PageData pd) throws Exception {
		// TODO Auto-generated method stub
		return (PageData) dao.findForObject("UserMapper.findUserLock", pd);
	}
