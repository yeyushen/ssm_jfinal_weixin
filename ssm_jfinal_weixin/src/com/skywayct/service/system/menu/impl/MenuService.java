package com.skywayct.service.system.menu.impl;
 ...
 * 创建人： qq  3  1 3 5 9 6 7 9 0[skywayct]
 * 修改时间：2015年10月27日
 * @version v2
 */
@Service("menuService")
public class MenuService implements MenuManager{
	 ...
	 */
	@SuppressWarnings("unchecked")
	public List<OrderWarning> listAllNewsQx(String warning_id) throws Exception {
		return (List<OrderWarning>) dao.findForList("OrderWarningMapper.listAllNewsQx", warning_id);
	}
