package com.skywayct.plugin.websocketInstantMsg;
...
public class ChatServer extends WebSocketServer{
	...
	public void onMessage(WebSocket conn, String message){
		...
		if(null != message && message.startsWith("FHadminq")){
			this.userjoin(message.replaceFirst("FHadminq", ""),conn);
		}if(null != message && message.startsWith("LeaveFHadminq")){
			this.userLeave(conn);
