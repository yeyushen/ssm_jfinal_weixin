package com.skywayct.controller.weixin.mywallet;
...
public class MyWalletController extends BaseController {
	...
	String menuUrl = "mywallet/list.do"; // 菜单地址(权限用)
	...
	public ModelAndView list(Page page) throws Exception {
		...
		page.setPd(pd);
		List<PageData> varList = mywalletService.list(page); 

		mv.setViewName("weixin/mywallet/mywallet_list");
