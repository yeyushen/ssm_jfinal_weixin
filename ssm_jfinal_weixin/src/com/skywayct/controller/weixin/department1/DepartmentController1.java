...
public class DepartmentController1 extends BaseController {
	
	String menuUrl = "department1/list.do"; //菜单地址(权限用)
	@Resource(name="departmentService1")
	private DepartmentManager1 departmentService;
	...
	public ModelAndView list(Page page) throws Exception{
		...
		mv.setViewName("weixin/department/department_list");
	...
	public ModelAndView listAllDepartment(Model model,String DEPARTMENT_ID)throws Exception{
		...
		try{
			...
			mv.addObject("pd", pd);	
			mv.setViewName("weixin/department/department_ztree");
		} catch(Exception e){
	...
	public ModelAndView goAdd()throws Exception{
		...
		mv.setViewName("weixin/department/department_edit");
