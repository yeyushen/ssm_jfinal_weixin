					...
					<form action="ordinarymember/${msg }.do" name="Form" id="Form" method="post">
						...
						<table id="table_report" class="table table-striped table-bordered table-hover">
							<tr>
								...
								<td><input type="text" name="openid" id="openid" value="${pd.openid}" maxlength="255" placeholder="这里输入微信Openid" title="微信Openid" style="width:98%;"/></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td><input type="text" name="name" id="name" value="${pd.name}" maxlength="255" placeholder="这里输入会员姓名" title="会员姓名" style="width:98%;"/></td>
							</tr>
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">性别:</td>
								<td><input type="text" name="sex" id="sex" value="${pd.sex}" maxlength="255" placeholder="这里输入会员性别" title="会员性别" style="width:98%;"/></td>
							</tr>
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">头像:</td>
								<td><input type="text" name="photo" id="photo" value="${pd.photo}" maxlength="255" placeholder="这里输入会员头像" title="会员头像" style="width:98%;"/></td>
							</tr>
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">手机号码:</td>
								<td><input type="text" name="phone" id="phone" value="${pd.phone}" maxlength="255" placeholder="这里输入手机号码" title="手机号码" style="width:98%;"/></td>
							</tr>
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">电话号码:</td>
								<td><input type="text" name="mobile" id="mobile" value="${pd.mobile}" maxlength="255" placeholder="这里输入电话号码" title="电话号码" style="width:98%;"/></td>
							</tr>
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">邮箱:</td>
								<td><input type="text" name="email" id="email" value="${pd.email}" maxlength="255" placeholder="这里输入邮箱" title="会员邮箱" style="width:98%;"/></td>
							</tr>
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">加入时间:</td>
								<td><input class="span10 date-picker" name="create_date" id="create_date" value="${pd.create_date}" type="text" data-date-format="yyyy-mm-dd" readonly="readonly" placeholder="加入时间" title="加入时间" style="width:98%;"/></td>
							</tr>
							<%-- <tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">加入时间:</td>
							...
							<tr>
								...
								<select class="chosen-select form-control" name="canceled" id="canceled" data-placeholder="请选择激活状态" style="vertical-align:top;" style="width:98%;" >
											<option value="" >请选择激活状态</option>
											<option value="0" <c:if test="${pd.canceled==0 }">selected</c:if>>是</option>
											<option value="1" <c:if test="${pd.canceled==1 }">selected</c:if>>否</option>
								</select>
								</td>
							</tr>
							<tr>
								...
								<select class="chosen-select form-control" name="level_id" id="level_id" data-placeholder="请选择角色" style="vertical-align:top;" style="width:98%;" >
											<option value="">请选择会员级别</option>
											<c:forEach items="${levelList}" var="level">
												<option value="${level.id }" <c:if test="${level.id == pd.level_id }">selected</c:if>>${level.level_name }</option>
											</c:forEach>
								</select>
									<%--下拉 <select class="chosen-select form-control" name="ROLE_ID" id="role_id" data-placeholder="请选择角色" style="vertical-align:top;" style="width:98%;" >
											<option value=""></option>
							...
							<tr>
								...
								<td><input type="text" name="parent_id" id="parent_id" value="${pd.parent_id}" maxlength="255" placeholder="这里输入上级" title="会员上级" style="width:98%;"/></td>
							</tr>
							<%-- <tr>
