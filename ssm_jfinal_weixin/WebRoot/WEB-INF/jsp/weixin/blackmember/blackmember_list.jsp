...
<body class="no-skin">
			...
			<div class="main-content-inner">
				<div class="page-content">
					<div class="row">
						...
						<!-- 检索  -->
						<form action="blackmember/list.do" method="post" name="Form" id="Form">
						<table style="margin-top:5px;">
							<tr>
								...
								<td style="vertical-align:top;padding-left:2px"><a class="btn btn-xs btn-info" onclick="gblack();"  title="检索">同步微信端黑名单</a></td>
								</c:if>
							</tr>
						</table>
						<!-- 检索  -->
	...
	<script type="text/javascript">
		...
		//同步
		function gblack(){
			window.location.href = '<%=basePath%>blackmember/getWXBlack.do';
		}
	</script>
