...
<body class="no-skin">
						...
						<div class="col-xs-12">
							...
							<form action="membertransfer/listChoiceAndParent.do"
								...
								<table>
									...
									<button class="btn btn-xs btn-info" onclick="()">搜索</button>
								</table>
							</form>
							</br>
							<form action="membertransfer/updateAllParent.do" method="post"
								...
								<table>
									...
									<a class="btn btn-xs btn-info" onclick="trans();">确认转移</a>
	...
	<script type="text/javascript">
		...
		function goBack(){
			top.jzts();
			window.location.href="<%=basePath%>membertransfer/list.do" ;
		};
