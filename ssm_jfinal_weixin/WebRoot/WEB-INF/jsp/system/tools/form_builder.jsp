...
<body class="gray-bg">
	...
	function getUeditorFormHtml(html,msg,isgx){
		var arryUe = html.split('<div class="ueQue"></div>');
		if(arryUe.length == 3){
			var uejscode = "<script id=\"editor\" type=\"text/plain\" style=\"width:96%;height:200px;\"><\/script>";
			if(msg == '1'){
				if(isgx == '2'){
					ueditorHtml = arryUe[1];
					return arryUe[0] + '<div class="ueQue"></div>' + uejscode + '<div class="ueQue"></div>' + arryUe[2];
				}else{
					return arryUe[0] + '<div class="ueQue"></div>' + ueditorHtml + '<div class="ueQue"></div>' + arryUe[2];
				}
			}else{
	...
	function getSelectFormHtml(html,msg,isgx){
		var arrySe = html.split('<div class="selQsel"></div>');
		if(arrySe.length == 3){
			...
			if(msg == '1'){
				if(isgx == '2'){
					return arrySe[0] + '<div class="selQsel"></div>' + selectcode + '<div class="selQsel"></div>' + arrySe[2];
				}else{
					selectHtml = arrySe[1];
					return html;
				}
	...
	function getFileFormHtml(html,msg,isgx){
		var arryFile = html.split('<div class="fileQfile"></div>');
		if(arryFile.length == 3){
			var filecode = "<input type=\"file\" id=\"tp\" name=\"tp\" />";
			if(msg == '1'){
				if(isgx == '2'){
					fileHtml = arryFile[1];
					return arryFile[0] + '<div class="fileQfile"></div>' + filecode + '<div class="fileQfile"></div>' + arryFile[2];
				}else{
					return arryFile[0] + '<div class="fileQfile"></div>' + fileHtml + '<div class="fileQfile"></div>' + arryFile[2];
				};
			}else{
